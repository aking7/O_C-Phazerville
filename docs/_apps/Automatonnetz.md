...
The `dx` and `dy` settings now have a much wider range of clock fractions available, from 1/64 to 1/2.

| Setting | Meaning                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dx`    | Amount of movement along x-axis (horizontal) per clock input. The value is a combination of a whole number and a fractional part.                                                                                                                                                                                                                                                                             |
| `dy`    | Amount of movement along y-axis (vertical) per clock input. The value is a combination of a whole number and a fractional part.                                                                                                                                                                                                                                                                               |
